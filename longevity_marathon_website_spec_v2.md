...
- **App-logged data:** the companion pre/post-run logging app writes directly to Supabase via its client SDK, gated by row-level security — no custom API server required. (Not yet built.)
